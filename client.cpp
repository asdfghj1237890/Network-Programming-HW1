...
void printInfo() {
    ...
    puts("--[cd <path>]");
    puts("     change working directory on remote server");
    puts("--[u <path/file>]");
    puts("     upload file to current working directory in remote server");
    puts("--[d <path/file>]");
    puts("     download file from server to Download folder");
    puts("--[exit]");
